...
/**
  This function frees the dynamically allocated memory in the structure
 */
...
/**
 A function to dynamically allocate the memory for the matrix
...
/**
 A function to find the power of (-1)
